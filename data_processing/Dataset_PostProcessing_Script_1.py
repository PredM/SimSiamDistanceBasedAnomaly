...
def main():
    ...
    y_train_window_times = np.load(
        config.training_data_folder + "train_window_times_2_.npy")  # labels of the training data
    y_test_window_times = np.load(
        config.training_data_folder + "test_window_times_2_.npy")  # labels of the training data
    y_train_failure_times = np.load(
        config.training_data_folder + "train_failure_times_2_.npy")  # labels of the training data
    y_test_failure_times = np.load(
        config.training_data_folder + "test_failure_times_2_.npy")  # labels of the training data
